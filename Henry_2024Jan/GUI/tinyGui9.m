function hyperspec_gui()
    ...
    hs_folder_txt = uicontrol('Style','text','Position',[200 205 280 20],'HorizontalAlignment','left');

    m_browse_btn = uicontrol('Style','pushbutton','String','Browse Mask Data','Position',[10 150 180 30],'Callback',@m_browse_callback);
    m_folder_txt = uicontrol('Style','text','Position',[200 155 280 20],'HorizontalAlignment','left');

    n_feature_inst = uicontrol('Style','text','Position',[10 100 120 25],'HorizontalAlignment','left','String','Enter n_feature:');
    n_feature_txt = uicontrol('Style','edit','Position',[130 100 60 25],'HorizontalAlignment','left','String','');

    perc_inst = uicontrol('Style','text','Position',[10 50 120 25],'HorizontalAlignment','left','String','Enter percentage:');
    perc_txt = uicontrol('Style','edit','Position',[130 50 60 25],'HorizontalAlignment','left','String','');

    load_btn = uicontrol('Style','pushbutton','String','Load Data','Position',[200 10 100 30],'Callback',@load_callback,'Enable','off');
